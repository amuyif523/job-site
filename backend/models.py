...
class Job(SQLModel, table=True):
    ...
    listing_summary: str = Field(default="")
    description: str = Field(default="")
    description_quality: str = Field(default="summary")
    intent_status: str = Field(default="included")
    intent_reason: str = Field(default="")
    matched_keywords: str = Field(default="[]")
    blocked_keywords: str = Field(default="[]")
    inferred_seniority: str = Field(default="unknown")
    source_confidence: str = Field(default="medium")
    enrichment_status: str = Field(default="pending")
    enrichment_error: str = Field(default="")
    enrichment_method: str = Field(default="")
    enrichment_duration_ms: int = Field(default=0)
    enrichment_retryable: bool = Field(default=False)
